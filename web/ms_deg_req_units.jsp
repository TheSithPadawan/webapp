...
<body>
    ...
    <%
        ...
        String view1 = "SELECT category_has_courses.category_type, sum(h2.units) as sum\n" +
                ...
                "where student.ssn = ?\n" +
                "group by category_has_courses.category_type";
        ...
        String view2 = "SELECT category2.category_type, category2.units\n" +
                ...
                "where degree.dept_name = '%s' and degree.deg_type = 'MS'";
        view2 = String.format(view2, dept_name);
